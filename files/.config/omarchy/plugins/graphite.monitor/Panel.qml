...
Panel {
      ...
      ScrollView {
        ...
        Column {
              ...
              G.PanelMeta {
                ...
                text: {
                  if (root.brightnessAvailable) {
                    return root.brightnessName(brightnessSlider.dragging ? brightnessSlider.liveValue : root.brightnessPercent).toLowerCase()
                  }
          ...
          G.Group {
            ...
            readonly property string valueText: String(Math.round(brightnessSlider.dragging ? brightnessSlider.liveValue : root.brightnessPercent))
            ...
            G.CursorSurface {
              ...
              G.PanelSlider {
                ...
                bar: root.bar
                anchors.left: parent.left
                anchors.right: brightnessField.left
                anchors.verticalCenter: parent.verticalCenter
                anchors.leftMargin: 8
              ...
              G.ValueField {
                id: brightnessField
                value: brightnessGroup.valueText
                unit: "%"
                anchors.right: parent.right
          ...
          G.Group {
            ...
            readonly property string valueText: String(textSizeSlider.dragging
            ...
            G.CursorSurface {
              ...
              G.PanelSlider {
                ...
                bar: root.bar
                anchors.left: parent.left
                anchors.right: textSizeField.left
                anchors.verticalCenter: parent.verticalCenter
                anchors.leftMargin: 8
                anchors.rightMargin: 10
                minimum: 0
          ...
          // ---------- Scale ----------
          // The count names the monitor that Scale changes, since it only
          // applies to the focused one. Only shown with more than one display.
          G.Group {
            id: scaleGroup
            title: "Scale"
            count: root.focusedMonitor !== "" && root.enabledDisplayCount > 1 ? root.focusedMonitor : ""
          ...
          G.Group {
            ...
            title: "Displays"
            count: String(root.displays.length)
  ...
  component ScalePill: G.Button {
    ...
    selected: root.activeScaleIndex() === scaleIndex
  ...
  component MonitorRow: G.CursorSurface {
    id: monitorRow
    ...
    Text {
      ...
      textFormat: Text.PlainText
      text: "󰍹"
      color: !monitorRow.canToggle ? G.Tokens.text4 : (monitorRow.hasCursor ? G.Tokens.accent : G.Tokens.text3)
      font.family: G.Tokens.valueFont
      font.pixelSize: 15
      anchors.left: parent.left
      anchors.leftMargin: 8
    ...
    G.Label {
      ...
      color: !monitorRow.canToggle ? G.Tokens.text4 : (monitorRow.hasCursor ? G.Tokens.text1 : G.Tokens.text2)
      anchors.left: monitorIcon.right
      anchors.leftMargin: 10
      anchors.right: monitorState.left
      anchors.rightMargin: 10
      anchors.verticalCenter: parent.verticalCenter
    }
    ...
    Row {
      ...
      G.StatusText {
        visible: monitorRow.isFocused
        text: "focused"
        status: "ok"
        anchors.verticalCenter: parent.verticalCenter
      }

      // Enabled displays are chosen: the check is accent.
      Text {
        textFormat: Text.PlainText
        text: monitorRow.display.enabled ? "󰄬" : ""
        color: monitorRow.canToggle ? G.Tokens.accent : G.Tokens.text4
        font.family: G.Tokens.valueFont
        font.pixelSize: 15
        width: 15
