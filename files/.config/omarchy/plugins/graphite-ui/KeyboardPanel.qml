...
//
// Graphite copy of Omarchy's Ui/KeyboardPanel.qml (see README.md). Changed:
// no border by default, surface-1 card, 16px radius, the panel shadow and a
// 1px top highlight. Everything else is Omarchy's code.
//
